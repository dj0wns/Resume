...
\begin{ressection}{Experience}
	\begin{ressubsecline}{Application Developer, Python and BigQuery}{Select Equity Group}{January 2025 -- April 2026}
	    ...
	    \ressubitem{Built a majority-voting validation framework utilizing ``two-of-three'' agreement logic to ensure the TDW remained correct and valid during BOD generation; proactively identified and mitigated vendor data errors to maintain a reliable system of record}
	    \ressubitem{Delivered interactive Tableau dashboards providing traders, researchers, and PMs with insights into portfolio construction and execution latency; implemented per-security TWR to isolate discretionary performance by excluding fund-flow impact, supplemented by UBS HOLT and CFROI metrics for additional valuation context}
	\end{ressubsecline}
...
\begin{ressection}{Projects}
  \begin{ressubseclinenodate}{Exavolt: Systems-Level Code Injection Framework}{Lead Developer \& Security Researcher}{x86 Assembly, PowerPC Assembly, Python}
      \ressubitem{Independently discovered and chained a buffer overflow and format string vulnerability to achieve novel arbitrary code execution (ACE) on the Original Xbox, establishing a persistent entry point for running root-level code in a retail hardware environment}
      \ressubitem{Architected the Exavolt framework to facilitate the arbitrary modification of core game logic and engine behavior via disk-embedded data and multi-stage assembly loaders; authored thousands of lines of handwritten assembly and automated the binary patching workflow via Python}
