...
\begin{ressection}{Projects}
  \begin{ressubseclinenodate}{Exavolt: Reverse Engineering and Assembly Code Injection}{Independent Research}{x86 and PowerPC Assembly, Python}
    \ressubitem{Independently discovered and chained a buffer overflow and format string vulnerability to achieve novel arbitrary code execution (ACE) in a retail hardware environment, establishing a persistent entry point for running root-level code in a retail environment}
